...
function t1() {
    ...
    get.open('GET', 'http://getpost.itgid.info/index2.php?action=1&auth=5ADcB96BA48d3f80');
    get.send();
}
...
function t2() {
    ...
    get.open('get', 'http://getpost.itgid.info/index2.php?action=2&auth=5ADcB96BA48d3f80&name=Yuriy');
    get.send();
}
...
function t3() {
    ...
    get.open('get', 'http://getpost.itgid.info/index2.php?action=3&auth=5ADcB96BA48d3f80&num1=15&num2=3');
    get.send();
}
...
function t4() {
    ...
    get.open('get', 'http://getpost.itgid.info/index2.php?action=4&auth=5ADcB96BA48d3f80&num1=3&num2=15')
    get.send();
}
...
function t5() {
    ...
    get.open('get', 'http://getpost.itgid.info/index2.php?auth=5ADcB96BA48d3f80&action=5');
    get.send();
}
...
function t6() {
    ...
    get.open('get', 'http://getpost.itgid.info/index2.php?auth=5ADcB96BA48d3f80&action=6&num1=1&num2=10');
    get.send();
}
...
function t7() {
    ...
    get.open('get', 'http://getpost.itgid.info/index2.php?auth=5ADcB96BA48d3f80&action=7');
    get.send();
}
...
function t8() {
    ...
    get.open('get', 'http://getpost.itgid.info/index2.php?auth=5ADcB96BA48d3f80&action=8&year=1997');
    get.send();
}
...
function t9() {
    ...
    get.open('get', 'http://getpost.itgid.info/index2.php?auth=5ADcB96BA48d3f80&action=9&m=1&d=1&y=1');
    get.send();
}
...
function t10() {
    ...
    post.open('post', 'http://getpost.itgid.info/index2.php');
    post.setRequestHeader('Content-type', 'application/x-www-form-urlencoded');
    post.send('auth=5ADcB96BA48d3f80&action=1');
}
...
function t11() {
    ...
    post.open('post', 'http://getpost.itgid.info/index2.php');
    post.setRequestHeader('Content-type', 'application/x-www-form-urlencoded');
    post.send('auth=5ADcB96BA48d3f80&action=2&name=Yuriy');
}
...
function t12() {
    ...
    post.open('post', 'http://getpost.itgid.info/index2.php');
    post.setRequestHeader('Content-type', 'application/x-www-form-urlencoded');
    post.send('auth=5ADcB96BA48d3f80&action=3&num1=1&num2=5');
}
...
function t13() {
    ...
    post.open('post', 'http://getpost.itgid.info/index2.php');
    post.setRequestHeader('Content-type', 'application/x-www-form-urlencoded');
    post.send('auth=5ADcB96BA48d3f80&action=4&num1=1&num2=5');
}
...
function t14() {
    ...
    post.open('post', 'http://getpost.itgid.info/index2.php');
    post.setRequestHeader('Content-type', 'application/x-www-form-urlencoded');
    post.send('auth=5ADcB96BA48d3f80&action=5');
}
...
function t15() {
    ...
    post.open('post', 'http://getpost.itgid.info/index2.php');
    post.setRequestHeader('Content-type', 'application/x-www-form-urlencoded');
    post.send('auth=5ADcB96BA48d3f80&action=6&num1=2&num2=16');
}
...
function t16() {
    ...
    post.open('post', 'http://getpost.itgid.info/index2.php');
    post.setRequestHeader('Content-type', 'application/x-www-form-urlencoded');
    post.send('auth=5ADcB96BA48d3f80&action=7');
}
...
function t17() {
    ...
    post.open('post', 'http://getpost.itgid.info/index2.php');
    post.setRequestHeader('Content-type', 'application/x-www-form-urlencoded');
    post.send('auth=5ADcB96BA48d3f80&action=8&year=1997');
}
...
function t18() {
    ...
    post.open('post', 'http://getpost.itgid.info/index2.php');
    post.setRequestHeader('Content-type', 'application/x-www-form-urlencoded');
    post.send('auth=5ADcB96BA48d3f80&action=9&m=1&d=1&y=1');
}
