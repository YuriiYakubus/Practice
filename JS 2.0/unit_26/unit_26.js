...
function t2() {
    fetch('http://getpost.itgid.info/index2.php?auth=5ADcB96BA48d3f80&action=2&name=Yuriy')
        .then(data => data.text())
        .then(data => {
...
function t3() {
    fetch('http://getpost.itgid.info/index2.php?auth=5ADcB96BA48d3f80&action=3&num1=2&num2=6')
        .then(data => data.text())
        .then(data => {
...
function t4() {
    fetch('http://getpost.itgid.info/index2.php?auth=5ADcB96BA48d3f80&action=4&num1=2&num2=6')
        .then(data => data.text())
        .then(data => {
...
function t6() {
    fetch('http://getpost.itgid.info/index2.php?auth=5ADcB96BA48d3f80&action=6&num1=12&num2=6')
        .then(data => data.text())
        .then(data => {
...
function t8() {
    fetch('http://getpost.itgid.info/index2.php?auth=5ADcB96BA48d3f80&action=8&year=1997')
        .then(data => data.text())
        .then(data => {
...
function t11() {
    fetch('http://getpost.itgid.info/index2.php', {
        ...
        body: 'auth=5ADcB96BA48d3f80&action=2&name=Yuriy'
    })
        .then(response => response.text())
        .then(response => {
...
function t12() {
    fetch('http://getpost.itgid.info/index2.php', {
        ...
        body: 'auth=5ADcB96BA48d3f80&action=3&num1=2&num2=6'
    })
        .then(response => response.text())
        .then(response => {
...
function t13() {
    fetch('http://getpost.itgid.info/index2.php', {
        ...
        body: 'auth=5ADcB96BA48d3f80&action=4&num1=2&num2=6'
    })
        .then(response => response.text())
        .then(response => {
...
function t15() {
    fetch('http://getpost.itgid.info/index2.php', {
        ...
        body: 'auth=5ADcB96BA48d3f80&action=6&num1=12&num2=1'
    })
        .then(response => response.text())
        .then(response => {
...
function t16() {
    fetch('http://getpost.itgid.info/index2.php', {
        ...
        .then(response => response.text())
        .then(response => {
            document.querySelector('.out-16').textContent = response;
        })
}
...
function t17() {
    fetch('http://getpost.itgid.info/index2.php', {
        ...
        body: 'auth=5ADcB96BA48d3f80&action=8&year=1997'
    })
        .then(response => response.text())
        .then(response => {
