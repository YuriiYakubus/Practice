...
function t3() {
    ...
    a3_res = a3.map(elem => parseInt(elem));
...
function t9() {
    ...
    document.querySelector('.out-9').textContent = b9_string + ' ' + b9_num;
}
