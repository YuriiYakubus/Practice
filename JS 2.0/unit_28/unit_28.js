...
let goods_4 = new Goods('Skulls', 25, './img/1.png', 47);
goods_4.draw()
...
let goods3 = new Goods2('Skulls', 25, './img/1.png', 47, true);
goods3.draw();
...
let valid = new Valid('yakubus@gmail.com', '12345', false);
valid.validate();
...
let valid_2 = new Valid('yakubus@gmail.com', '1234567', false);
valid_2.validate();
console.log(valid_2.isValid);
...
let valid2 = new Valid2('', '1234567', false, '', '');
valid2.validate();
console.log(valid2);
...
let valid3 = new Valid2('yafds@gmail.com', '1234567', false, '', '');
valid3.validate();
console.log(valid3);