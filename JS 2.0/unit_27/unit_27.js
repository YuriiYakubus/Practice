...
function t2() {
    ...
    let b = new Promise((resolve, reject) => {
        fetch('http://getpost.itgid.info/index2.php?auth=5ADcB96BA48d3f80&action=4&num1=1&num2=5')
            .then(data => {
                resolve(data.text());
            })
    });
...
function t3() {
    ...
    let b = new Promise((resolve, reject) => {
        fetch('http://getpost.itgid.info/index2.php?auth=5ADcB96BA48d3f80&action=6&num1=1&num2=5')
            .then(data => {
                resolve(data.text());
            })
    });
...
function t4() {
    ...
    let b = new Promise((resolve, reject) => {
        fetch('http://getpost.itgid.info/index2.php?auth=5ADcB96BA48d3f80&action=6&num1=1&num2=8&year=1997')
            .then(data => {
                resolve(data.text());
            })
    });
...
function t5() {
    ...
    let b = new Promise((resolve, reject) => {
        fetch('http://getpost.itgid.info/index2.php', {
            ...
            body: 'auth=5ADcB96BA48d3f80&action=2'
        })
            .then(response => resolve(response.text()))
    });
...
function t6() {
    let a = new Promise((resolve, reject) => {
        fetch('http://getpost.itgid.info/index2.php', {
            ...
            body: 'auth=5ADcB96BA48d3f80&action=3&num1=2&num2=3'
        })
            .then(response => resolve(response.text()))
    });
    ...
    let b = new Promise((resolve, reject) => {
        fetch('http://getpost.itgid.info/index2.php', {
            ...
            body: 'auth=5ADcB96BA48d3f80&action=4&num1=2&num2=10'
        })
            .then(response => resolve(response.text()))
    });
...
function t7() {
    ...
    let b = new Promise((resolve, reject) => {
        fetch('http://getpost.itgid.info/index2.php', {
            ...
            body: 'auth=5ADcB96BA48d3f80&action=6&num1=2&num2=10'
        })
            .then(response => resolve(response.text()))
    });
