...
function t2() {
    ...
    a2.map(elem => a2_res.push(Math.pow(elem, 2)));
...
function t3() {
    ...
    a3.map(elem => a3_res.push(parseInt(elem)));
...
function t7() {
    ...
    b7_res = b7.filter(elem => typeof elem === 'string');
...
function t9() {
    ...
    document.querySelector('.out-9').innerHTML = b9_num + ' ------- ' + b9_string;
}
