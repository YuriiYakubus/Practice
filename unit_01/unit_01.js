...
document.querySelector('.three').innerHTML = '<h3>Hedaer lvl 3</h3>';
...
document.querySelector('.four').innerHTML = '<h4>lvl 4 Header</h4>';
document.querySelector('.four').innerHTML += '<p>Paragraph</p>'
