...
function t5() {
    let size = a2_res.size;
    return document.querySelector('.out-5').innerHTML = size;
}
...
function t6(a6) {
    let set6 = new Set(a6);
    return document.querySelector('.out-6').innerHTML = set6.size;
}
