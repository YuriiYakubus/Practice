...
function t10() {
    ...
    document.querySelector('.out-10').innerHTML = input * 10;
    input = '';
}
...
function t11() {
    ...
    document.querySelector('.out-11').innerHTML = input + 10;
    input = '';
}
...
function t12() {
    let input1 = document.querySelector('.i-12_1').value;
    let input2 = document.querySelector('.i-12_2').value;

    document.querySelector('.out-12').innerHTML = 'Hello ' + input1 + ' ' + input2;
}
...
function t13() {
    let input_1 = +document.querySelector('.i-13_1').value;
    let input_2 = +document.querySelector('.i-13_2').value;

    document.querySelector('.out-13').innerHTML = input_1 + input_2;
}
...
function t16() {
    let input1 = +document.querySelector('.i-16_1').value;
    let input2 = +document.querySelector('.i-16_2').value;

    document.querySelector('.out-16').innerHTML = input1 + input2;
}
...
function t19() {
    let input1 = document.querySelector('.i-19_1').value;
    let input2 = document.querySelector('.i-19_2').value;

    document.querySelector('.out-19').innerHTML = parseInt(input1) + parseInt(input2);
}
...
function t20() {
    let name = document.querySelector('.i-20_1').value;
    let sureName = document.querySelector('.i-20_2').value;
    let age = document.querySelector('.i-20_3').value;
    let work = document.querySelector('.i-20_4').value;

    document.querySelector('.out-20').innerHTML = 'Уважаемый ' + name + ', ' + sureName + ', ' + 'ваш возраст ' + age + ' года, по професси вы ' + work;
}
