...
function f7() {
    ...
    out.innerHTML = Math.pow(input1, input2);
}
...
function f8() {
    let selectedValue = +document.querySelector('.s-8').value;
...
function f10() {
    let input1 = +document.querySelector('.i-101').value;
    let input2 = +document.querySelector('.i-102').value;
    let select = document.querySelector('.s-103').value;
...
function f11() {
    let select1 = +document.querySelector('.s-111').value;
    let select2 = +document.querySelector('.s-112').value;
    let select3 = document.querySelector('.s-113').value;
